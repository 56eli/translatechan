...
- `partial_or_failed_w1_collation`: **0** manifest records are not fully supported by W1 collation; per-document remediation remains pending.
...
├── data/
│   ├── corpus_manifest.json    # Shared active-corpus order/navigation manifest (14 keys)
