...
- **Boot cost (Checkpoint-C C-4, Phase 2):** one bundle, render-lazy — the Reader renders at boot and the four hidden rooms (Matrix, Lineage, Gong'an, Lexicon) build their DOM on first tab activation; data loading and the byte-identical bundle contract are unchanged. The bundle size is printed by `scripts/build_data_bundle.py` at build time — no hand-typed byte figure here, and the retired 2 MB Phase-3 tracking line no longer applies after the 2026-09-21 ingests — measured `gzip -c app_data.js app.js app.css index.html | wc -c` on main 3a6ae32. **This is the Phase-3 measurement, not today's**: the published bundle has since grown with the 36th corpus document (2026-09-20 Congronglu reinstatement) to raw 2,525,870 B (~2.41 MB) / gzipped 787,454 B for the same four files — the 2 MB tracking line is exceeded, it was never a CI gate, and the current authoritative byte count is the one `scripts/build_data_bundle.py` prints at build time.
...
- **1 verified quotation slots across 1 corpus texts + 2 verified comparative-matrix entries** (the historical Wumenguan quotation set covered 48/48 represented cases; this English quotation result is separate from W1 source collation). Corpus and Matrix verified items carry work/edition/verification fields plus a rights-manifest source identifier under provenance policy v2.2.
...
> **Honest status**: the active corpus contains **16 documents**; **11 of 16 documents** are `complete_selected_witness` (`wumenguan` since its 2026-09-21 re-key; the other ten marked on 2026-09-22 by task 058, `sessions/P1_COMPLETE_MARKING_2026-09-22.md`: `linji_yulu`, `congronglu`, `chuandenglu_full`, `caoshan_benji`, `huangbo_fayao_full`, `mazu_guanglu_full`, `yunmen_guanglu_full`, `dongshan_yulu_full`, `zhaozhou_yulu_full`, `dahui_yulu_full` — each one `collated_to_claimed_witness` with 0 flagged fields, its unit target equal to the units present, and its units re-verified on 2026-09-22 as a verbatim, contiguous tiling of the pinned witness region under extraction rule `cbeta-p5-body-cjk-v1`; "complete" means *that region, whole* — the rule drops the witness's interlinear `tei:note` apparatus, and the front/back matter and structural case-name markers each `coverage_note` discloses stay outside the claim), and the 5 remaining documents are excerpt seeds (`zhengdao_ge` — collated, 6 stanzas, no unit target; `hanshan_poems` and `niutou_juezhu` — `witness_unavailable`; `guiyang_yulu` and `fayan_yulu` — the two purged Tier2 retelling keys restored on 2026-09-22 by task 059 as measured excerpt seeds after their re-key attempts were measured and NOT landed, so the task-056 authenticity labels stand with the restored bytes). W1 evidence: **16 documents, 41 flagged source fields** (authoritative 2026-09-22 P2 Tier2 batch1 overlay: `sessions/COLLATION_REGISTER_2026-09-22_P2_TIER2_BATCH1.json` — the two purged Tier2 retelling keys restored as measured excerpt seeds (Guiyang 0 of 6, Fayan 1 of 11 source-content fields verbatim; re-key NOT landed) as documents 15 and 16, re-measuring the 14 entries of the 2026-09-21 combined Wumenguan/Linji overlay `sessions/COLLATION_REGISTER_2026-09-21_WUMENGUAN_LINJI.json` byte-identically — the re-keyed Gateless Gate T48n2005 as the 13th document and the re-keyed Record of Linji T47n1985 as the 14th, inheriting the 12 entries of the 2026-09-21 enthusiast fulls overlay `sessions/COLLATION_REGISTER_2026-09-21_ENTHUSIAST_100PCT.json` verbatim, which itself inherits the 38 entries of the 2026-09-20 Caoshan Benji overlay `sessions/COLLATION_REGISTER_2026-09-20_CAOSHAN_BENJI.json`, the 37 entries of the 2026-09-20 full-Jingde-Chuandeng-Lu overlay `sessions/COLLATION_REGISTER_2026-09-20_CHUANDENGLU_FULL.json`, the 36 entries of the 2026-09-20 correction overlay `sessions/COLLATION_REGISTER_2026-09-20_CORRECTION.json`, and the 35 entries of the 2026-09-10 correction register `sessions/COLLATION_REGISTER_2026-09-10_CORRECTION.json` plus the Congrong Lu reinstatement; historical 2026-09-09 register: `sessions/COLLATION_REGISTER_2026-09-09.json` with 34 documents and 622 flagged fields — the 637 figure in the 2026-09-09 report is **superseded**); 4,709 of 4,734 source-content fields collate to their claimed witness, and 3 documents have no collating source-content field at all (the two witness-unavailable seeds plus guiyang_yulu); a fresh collation of current `main` reports **486** flagged fields — the difference is the four merged re-keys (PRs #29, #30, #32, #34) the 2026-09-20 Congronglu reinstatement and the 2026-09-20 full 30-fascicle Jingde Chuandeng Lu ingest and the 2026-09-20 Caoshan Benji ingest and the 2026-09-21 six full-witness ingests — and the owner ruled on 2026-09-12 that the published post-remediation evidence pass (PR #41) does **not** supersede the register: **630** stays the historical chain's designated figure and 486 stays the measurement over the former 44 documents. Wumenguan has **48 / 48 cases represented; W1 source-review status: `collated_to_claimed_witness`**; the Record of Linji was re-keyed verbatim from its claimed witness on 2026-09-21 (the whole T47n1985 fascicle in 107 contiguous sections, 215/215 measured fields EXACT, 0 flagged, `collated_to_claimed_witness`). Biyanlu is no longer part of the active corpus after the 2026-09-21 purge; 5 records remain excerpt seeds — on 2026-09-22 (task 059) the purged Guiyang/Fayan Tier2 retelling keys returned as measured excerpt seeds (guiyang 0 of 6, fayan 1 of 11 source-content fields verbatim; re-key NOT landed). The manifest source-review counts are `collated_to_claimed_witness`: **12**, `partial_or_failed_w1_collation`: **2**, and `witness_unavailable`: **2**. Platform Sutra has 10/10 chapter headings represented, but is not a complete text: its 13 source-content fields (680 content CJK) are now provenance-labelled — 1 verbatim in the primary witness T48n2007 (Dunhuang), 3 in the alternative T48n2008 (宗寶), and 9 in neither, disclosed as project précis. The Congronglu seed removed after the 2026-08-10 audit (uncollated generated placeholders, incorrect case-number/page claims) was rebuilt from scratch out of the authoritative T48n2004 witness and reinstated on 2026-09-20: 100/100 cases, 500/500 source-content fields collating, 0 flagged, none of the quarantined records copied. The Caoshan Benji record (撫州曹山元證禪師語錄, T47n1987A) was extracted from scratch on 2026-09-20 as the 38th document — 84/84 units, 84/84 source-content fields collating, 0 flagged. On 2026-09-21 six full-witness records were ingested as documents 39–44 by `scripts/segment_full_witness.py`: Huangbo's Transmission of Mind (T48n2012A, 19 units), Mazu as printed in X69n1321 (35), the Yunmen Guanglu (T47n1988, 776), both Dongshan fascicle parts (T47n1986A+B, 322), Zhaozhou as printed in the Guzunsu yulu juan 13–14 (X68n1315, 80) and the complete Dahui Yulu with the juan 25–30 letters plus the Zongmen huku (T47n1998A+B, 1,354) — 2,586/2,586 source-content fields collating verbatim, 0 flagged, 302,592 new source-content CJK; the four seeds they complete keep their own flagged entries unchanged. Generated metrics report **775,562 source-content CJK characters** (or 833,842 across every corpus JSON string, including metadata); representation counts never establish completion by themselves — the 11 completion marks above are explicit editorial `completion_status` values that the validator only counts when the W1 status is `collated_to_claimed_witness` and every declared unit target is met (`complete_document_keys()` in `scripts/validate_data.py`).

| Text Name (English) | Classical Chinese | CBETA Canon ID | Author / Compiler | Current Coverage |
| :--- | :--- | :--- | :--- | :--- |
| **The Gateless Gate** | 禪宗無門關 | **T2005** (Vol. 48) | Wumen Huikai (無門慧開, 1228 CE) | **48 / 48 cases represented; W1 source-review status: `collated_to_claimed_witness`** |
| **The Record of Linji** | 鎮州臨濟慧照禪師語錄 | **T1985** (Vol. 47) | Linji Yixuan / Sansheng Huiran | **107 / 107 sections represented; W1 source-review status: `collated_to_claimed_witness`** — rebuilt 2026-09-21 (task P2.9) from the pinned witness: the whole 16,366-CJK fascicle in 107 verbatim contiguous sections, 215 measured fields, 215 EXACT, 0 flagged |
...
- `collated_to_claimed_witness`: **12** documents fully collated to their claimed witness in the W1-evaluated set (`zhengdao_ge`, `wumenguan`, `linji_yulu`, the 2026-09-20 Congronglu reinstatement, the 2026-09-20 full 30-fascicle Jingde Chuandeng Lu, the 2026-09-20 Caoshan Benji record, and the six 2026-09-21 full-witness records `huangbo_fayao_full`, `mazu_guanglu_full`, `yunmen_guanglu_full`, `dongshan_yulu_full`, `zhaozhou_yulu_full` and `dahui_yulu_full` — every one of their 2,586 source-content fields verbatim in its claimed witness).
- `partial_or_failed_w1_collation`: **2** manifest records are not fully supported by W1 collation; per-document remediation remains pending.
...
- Sentence-by-sentence Classical Chinese with pinyin and disclosed English registers across all 14 active corpus documents.
...
- Client-side search across **all 14 active corpus documents and supported schema shapes** (case lists, sermons, dialogues, stanzas, chapters), with match counts, highlighting, and jump actions.
...
- Chronological and genealogical mapping from Bodhidharma (d. ~532 CE) through the Six Patriarchs, Mazu, Shitou, Baizhang, Huangbo, to the Five Houses — currently **60 master profiles** (the 35-profile base plus 25 conservatively sourced lineage-expansion profiles), with the network chart as its second view and clickable dossiers.
...
├── data/
│   ├── corpus_manifest.json    # Shared active-corpus order/navigation manifest (16 keys)
...
│   ├── corpus/                 # 13 active structured source files after the 2026-09-21 purge
│   │   ├── linji_yulu.json           # 107 verbatim sections, T47n1985 (re-keyed 2026-09-21)
│   │   ├── congronglu.json
│   │   ├── chuandenglu_full.json
│   │   └── ... (10 more: yulu, treatises, poems — see data/corpus/)
│   ├── editorial/          # Enforced document-level source-locator migration queue (4 records)
