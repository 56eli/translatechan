...
The 2026-09-09 W1 report and register are the current evidence for Classical Chinese source review. These are containment/remediation states, **not rights decisions**:
...
The three ledgers remain separate: **represented units** describe what the Reader contains; **source collation status** describes W1 evidence against a claimed witness; **edition-verified English quotations** describe wording checks for translation slots; **rights review status** records permission/jurisdiction work and is never inferred from either collation or edition verification. W1 evidence is recorded in [`sessions/COLLATION_W1_2026-09-09.md`](./sessions/COLLATION_W1_2026-09-09.md) and [`sessions/COLLATION_REGISTER_2026-09-09.json`](./sessions/COLLATION_REGISTER_2026-09-09.json).
...
- Visible source locations, W1 source-review disclosures, and validator-derived coverage disclosures distinguish **source collation status**, **complete/partial/excerpt representation**, and locator review; raw N/M representation counts never establish source completion.
