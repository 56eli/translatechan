...
- `collated_to_claimed_witness`: **10** documents fully collated to their claimed witness in the W1-evaluated set (`zhengdao_ge`, the 2026-09-20 Congronglu reinstatement, the 2026-09-20 full 30-fascicle Jingde Chuandeng Lu, the 2026-09-20 Caoshan Benji record, and the six 2026-09-21 full-witness records `huangbo_fayao_full`, `mazu_guanglu_full`, `yunmen_guanglu_full`, `dongshan_yulu_full`, `zhaozhou_yulu_full` and `dahui_yulu_full` — every one of their 2,586 source-content fields verbatim in its claimed witness).
...
├── data/
│   ├── corpus_manifest.json    # Shared active-corpus order/navigation manifest (12 keys)
