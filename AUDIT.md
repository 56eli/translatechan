...
- Source volume: **855,603 content CJK / 917,810 all-string CJK**.
>>>>>>> tmp-050
...
- Lineage: **35 masters**; **12 controlled `school_key` groups**; **31 edge records + 4 frontiers**; 20 edges are `exact_locator_verified`, 10 are `source_verified`; 1 traditional link (dahong_zuzheng → yuelin_shiguan) remains `traditional_link_pending_exact_locator`, documented as an intentional frontier pending exact locator (2026-09-21 P3 frontier final, `sessions/P3_LINEAGE_FRONTIER_FINAL_2026-09-21.md`).
