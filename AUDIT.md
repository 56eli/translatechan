...
<<<<<<< HEAD
- Corpus: **13 documents**; Source review: **11 collated**, **0 partial/failed**, **2 unavailable**; **0 complete selected witnesses** after W1 containment. Wumenguan **48/48 cases** represented; W1 source-review status: `partial_or_failed_w1_collation`. Xinxin Ming has 37/37 represented stanzas with the same partial/failed state. Biyanlu **100/100 cases** represented; Biyanlu and Linji remain partial; **3 excerpt seeds**.
- Source volume: **767,450 content CJK / 824,896 all-string CJK**.
=======
- Corpus: **13 documents**; Source review: **11 collated**, **0 partial/failed**, **2 unavailable**; **0 complete selected witnesses** after W1 containment. Wumenguan **48/48 cases** represented; W1 source-review status: `partial_or_failed_w1_collation`. Xinxin Ming has 37/37 represented stanzas with the same partial/failed state. Biyanlu **100/100 cases** represented; Biyanlu and Linji remain partial; **3 excerpt seeds**.
- Source volume: **767,450 content CJK / 824,896 all-string CJK**.
>>>>>>> tmp-050
- Translations: **46 corpus slots**; **1 verified quotations**; **21 matrix registers**; verified-reference coverage **2 recorded / 1 pending**.
- Locators: **4044/4044 case-level**; **4 document-level seeds**; case anchors do not prove every nested field was collated.
