...
- Source volume: **758,747 content CJK / 814,652 all-string CJK**.
- Translations: **46 corpus slots**; **1 verified quotations**; **21 matrix registers**; verified-reference coverage **2 recorded / 1 pending**.
- Locators: **4092/4092 case-level**; **3 document-level seeds**; case anchors do not prove every nested field was collated.
