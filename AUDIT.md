...
> **Current evidence (authoritative, dated correction overlay):** [`sessions/COLLATION_W1_2026-09-20_CAOSHAN_BENJI.md`](./sessions/COLLATION_W1_2026-09-20_CAOSHAN_BENJI.md) · [`sessions/COLLATION_REGISTER_2026-09-20_CAOSHAN_BENJI.json`](./sessions/COLLATION_REGISTER_2026-09-20_CAOSHAN_BENJI.json) · [`sessions/COLLATION_W1_2026-09-20_CAOSHAN_BENJI_refs_manifest.txt`](./sessions/COLLATION_W1_2026-09-20_CAOSHAN_BENJI_refs_manifest.txt)
>
...
- Source volume: **553,011 content CJK / 583,291 all-string CJK**.
...
- Locators: **1606/1606 case-level**; **33 document-level seeds**; case anchors do not prove every nested field was collated.
- Lineage: **35 masters**; **12 controlled `school_key` groups**; **31 edge records + 4 frontiers**; all 31 edges remain traditional/pending.
...
- Flagged fields after the campaign: the authoritative 2026-09-20 overlay holds **630**; a fresh collation of current `main` reports **486** over all 38 documents (`COLLATION_REFS=<refs> python3 scripts/collate_corpus.py --require-verified-refs --refs-manifest sessions/COLLATION_W1_2026-09-20_CAOSHAN_BENJI_refs_manifest.txt`) — the difference is the four merged re-keys plus the 2026-09-20 Congronglu, Jingde-Chuandeng-Lu and Caoshan Benji ingests — and the owner ruled on 2026-09-12 that the published post-remediation evidence pass (PR #41) does **not** supersede the register: **630** stays authoritative and **486** stays today's measurement of `main`.
