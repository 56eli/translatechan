...
- Corpus: **36 documents**; Wumenguan **48/48 cases** complete; Biyanlu **100/100 cases** (**complete ✅**); **35 excerpt seeds**; **96,327 content CJK / 100,864 all-string CJK**.
- Translations: **985 corpus slots**; **138 verified quotations**; **21 matrix registers**; verified-reference coverage **135 recorded / 5 pending**.
