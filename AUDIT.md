...
- Corpus: **36 documents**; Wumenguan **48/48 cases** complete; Biyanlu **100/100 cases** (**complete ✅** — both counted by the manifest-target completeness metric now, no longer hardcoded); **34 excerpt seeds**; **88,263 content CJK / 92,450 all-string CJK**.
- Translations: **949 corpus slots**; **138 verified quotations**; **21 matrix registers**; verified-reference coverage **135 recorded / 5 pending**.
...
- Bundle: ~1.36 MB zero-backend static build (grew with the Biyanlu 100/100 completion); root and `/docs` byte-identical by CI gate.
...
3. **Content Phase 2:** continue the CBETA-collated completion campaign (ROADMAP.md). **Biyanlu is now complete (100/100, 2026-08-09)** — the Linji yulu completion pilot is the natural next target; every new text runs the established locator/provenance/metrics workflow.
