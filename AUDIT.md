...
- Corpus: **36 documents**; Wumenguan **48/48 cases** complete; Biyanlu **100/100 cases** (**complete ✅**); **35 excerpt seeds**; **99,302 content CJK / 104,030 all-string CJK**.
- Translations: **1001 corpus slots**; **138 verified quotations**; **21 matrix registers**; verified-reference coverage **135 recorded / 5 pending**.
