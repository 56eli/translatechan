...
- Corpus: **36 documents**; Wumenguan **48/48 cases** complete; Biyanlu **16/100 cases** (cases 1–14 complete); **35 excerpt seeds**; **24,613 content CJK / 27,933 all-string CJK**.
- Translations: **871 corpus slots**; **138 verified quotations**; **21 matrix registers**; verified-reference coverage **135 recorded / 5 pending**.
- Locators: **66/66 case-level**; **33 document-level seeds** pending unit locators.
