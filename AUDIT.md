...
- Corpus: **14 documents**; Source review: **12 collated**, **0 partial/failed**, **2 unavailable**; **11 of 14 documents** are `complete_selected_witness` (the re-keyed Gateless Gate since 2026-09-21; on 2026-09-22 task 058 marked the ten collated, 0-flagged, unit-target-met documents `congronglu`, `chuandenglu_full`, `caoshan_benji`, `huangbo_fayao_full`, `mazu_guanglu_full`, `yunmen_guanglu_full`, `dongshan_yulu_full`, `zhaozhou_yulu_full`, `dahui_yulu_full` and `linji_yulu` after an independent re-verification that each tiles its pinned witness region verbatim and contiguously — [`sessions/P1_COMPLETE_MARKING_2026-09-22.md`](./sessions/P1_COMPLETE_MARKING_2026-09-22.md); the 3 that are not complete are the excerpt seeds `zhengdao_ge`, `hanshan_poems`, `niutou_juezhu`). Wumenguan **48/48 cases** represented; W1 source-review status: `collated_to_claimed_witness`; the Record of Linji **107/107 sections** re-keyed verbatim from the pinned T47n1985 witness (215/215 measured fields EXACT, 0 flagged); **3 excerpt seeds**.
- Source volume: **775,113 content CJK / 832,897 all-string CJK**.
- Translations: **46 corpus slots**; **1 verified quotations**; **21 matrix registers**; verified-reference coverage **2 recorded / 1 pending**.
- Locators: **4092/4092 case-level**; **4 document-level seeds**; case anchors do not prove every nested field was collated.
