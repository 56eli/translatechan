...
- Corpus: **36 documents**; Wumenguan **48/48 cases** complete; Biyanlu **22/100 cases** (cases 1–21, 43 complete); **35 excerpt seeds**; **32,087 content CJK / 35,483 all-string CJK**.
...
- Locators: **72/72 case-level**; **33 document-level seeds** pending unit locators.
