...
- Corpus: **36 documents**; Wumenguan **48/48 cases** complete; Biyanlu **43/100 cases** (cases 1–43 complete); **35 excerpt seeds**; **49,242 content CJK / 52,845 all-string CJK**.
- Translations: **892 corpus slots**; **138 verified quotations**; **21 matrix registers**; verified-reference coverage **135 recorded / 5 pending**.
- Locators: **93/93 case-level**; **33 document-level seeds** pending unit locators.
