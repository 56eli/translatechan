...
- Corpus: **36 documents**; Wumenguan **48/48 cases** complete; Biyanlu **16/100 cases** (cases 1–14, 21, 43 complete); **35 excerpt seeds**; **25,926 content CJK / 29,258 all-string CJK**.
- Translations: **865 corpus slots**; **138 verified quotations**; **21 matrix registers**; verified-reference coverage **135 recorded / 5 pending**.
