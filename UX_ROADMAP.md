...
> **Status (2026-08-10): historical functional roadmap.** Most 2026-08-08 items below were implemented, but their evidence/descriptions are snapshots and several visual assumptions were superseded. Current design authority is [`sessions/WEB_DESIGN_GAP_PLAN_2026-08-10.md`](./sessions/WEB_DESIGN_GAP_PLAN_2026-08-10.md); shell/Reader Phase A+B and secondary-room Phase C+D are implemented. The [current audit](./sessions/AUDIT_RESPONSE_2026-08-10_019fecb1.md) identified—and the [follow-up](./sessions/RELEASE_BLOCKERS_2026-08-10_019fecb1.md) repaired—the Lineage directory semantic/mobile defect. Phase E real-browser evidence and owner approval remain.
>
