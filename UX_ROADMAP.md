...
> **Status (2026-08-10): historical functional roadmap.** Most 2026-08-08 items below were implemented, but their evidence/descriptions are snapshots and several visual assumptions were superseded. Current design authority is [`sessions/WEB_DESIGN_GAP_PLAN_2026-08-10.md`](./sessions/WEB_DESIGN_GAP_PLAN_2026-08-10.md); structural shell/Reader Phase A+B is recorded in [`sessions/DESIGN_PHASE_AB_2026-08-10.md`](./sessions/DESIGN_PHASE_AB_2026-08-10.md), and secondary-room Phase C+D in [`sessions/AUDIT_RESPONSE_2026-08-10_019fec5c.md`](./sessions/AUDIT_RESPONSE_2026-08-10_019fec5c.md). Phase E evidence/approval remains, and the [current audit](./sessions/AUDIT_RESPONSE_2026-08-10_019fecb1.md) found a Lineage directory hidden-state defect that must be fixed first.
>
