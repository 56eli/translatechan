...
for (const [key, expect] of [['wumenguan', '48/48 cases'], ['biyanlu_cases', '80/100 cases'], ['congronglu_cases', '2/100 cases'], ['platform_sutra', '4/10 chapters']]) {
...
if (!biyanCovHtml.includes('📊 Coverage: 80/100 cases')) { failures++; console.log('❌ Biyanlu coverage disclosure missing'); }
corpusClicks['wumenguan'] && corpusClicks['wumenguan']();
