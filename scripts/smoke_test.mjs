...
// 2026-09-22 (task 061): re-pin 16 to the manifest's measured 17 active documents.
...
// 2026-09-22 (task 061): re-pin 12 collated to the register-derived 13 after Biyanlu.
...
// 2026-09-22 (task 061): re-pin Tier2 paths, 16 docs/41 flags to Biyanlu's 17/127 and cited successor.
const authoritativeEvidence = {
  correction_report_path: 'sessions/COLLATION_W1_2026-09-22_P1_BIYANLU_DIGESTS.md',
...
// 2026-09-22 (task 061): re-pin both 16 counts to the measured 17 corpus/locator documents.
...
// 2026-09-22 (task 061): re-pin 16 to the measured 17 per-text metric entries.
...
try {
  ...
  // 2026-09-22 (task 061): re-pin the 11 complete witnesses to the measured 12 including Biyanlu.
  ...
  // 2026-09-22 (task 061): re-pin 11 marks to the measured 12 complete documents.
  if (completeMarks !== 12) {
...
try {
  ...
  if (!filterInput) { failures++; console.log('❌ 4hh: #corpus-filter-input missing'); }
    ...
    // 2026-09-22 (task 061): re-pin 16 to 17; a smoke run confirmed this counts active documents.
    if (restoredCount !== 17) {
