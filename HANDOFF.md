...
> **Canonical tracker:** [`docs/PROJECT_STATE.md`](./docs/PROJECT_STATE.md) (v4.9.0 Knowledge Bridge Doctrine) — Owner Vision, Scope Boundaries, Invariants, Settled Decisions, Active Milestone, Current State, Immediate Next Task
