...
- Every displayed translation exposes its translator/label, status, book/edition, page-or-section state, verification, and rights record. **136 / 141** verified quotation records have a recorded reference; the remaining **5** are explicitly pending.
...
python3 scripts/validate_data.py          # corpus=36 | slots=1023 | verified=139 | matrix=21 | locators=150/150
