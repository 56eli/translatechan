...
content CJK=553,011 | all-string CJK=583,291
source-review: collated=4 | partial/failed=32 | unavailable=2
w1-evidence: flagged=630 (authoritative 2026-09-20 Caoshan Benji overlay) | historical=622 (2026-09-09) | report-figure-superseded=637
...
complete=0 | partial=7 | excerpt seeds=31
lineage=35 masters / 31 edges | glossary=31 | gong'an=24
app_data.js=4,851,526 B raw / 38 documents (the authoritative byte count is printed by scripts/build_data_bundle.py at build time)
