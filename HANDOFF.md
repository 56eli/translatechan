...
- Every public Reader document/case shows a canonical source location plus hover/focus/touch details and a validator-derived coverage disclosure (e.g. `48/48 cases`, `50/100 cases`, `Excerpt seed (N units)`).
...
python3 scripts/validate_data.py          # corpus=36 | slots=899 | verified=138 | matrix=21 | locators=100/100
