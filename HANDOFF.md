...
> **Current audit/status:** [`AUDIT.md`](./AUDIT.md) · W1 evidence (authoritative, dated 2026-09-20): [`sessions/COLLATION_W1_2026-09-20_CORRECTION.md`](./sessions/COLLATION_W1_2026-09-20_CORRECTION.md), which inherits the [2026-09-10 correction overlay](./sessions/COLLATION_W1_2026-09-10_CORRECTION.md) · W1 evidence (historical, append-only): [`sessions/COLLATION_W1_2026-09-09.md`](./sessions/COLLATION_W1_2026-09-09.md)
...
```text
corpus=37 | slots=1252 | verified=177 | matrix=21 | locators=1522/1522
content CJK=189,629 | all-string CJK=199,094
source-review: collated=3 | partial/failed=32 | unavailable=2
w1-evidence: flagged=630 (authoritative 2026-09-20 overlay) | historical=622 (2026-09-09) | report-figure-superseded=637
...
w1-fresh-collation: flagged=486 on current main vs register=630 (2026-09-20 overlay) — register **not** superseded: owner ruled 2026-09-12 that the post-remediation evidence pass (PR #41) does not replace it, so 630 stays authoritative
complete=0 | partial=4 | excerpt seeds=31
lineage=34 masters / 30 edges | glossary=31 | gong'an=24
app_data.js=2,136,279 B raw / 36 documents (the authoritative byte count is printed by scripts/build_data_bundle.py at build time)
...
gzipped); it was never a CI gate, and the 36-document bundle of 2026-09-20 exceeds it, so the
current 2,136,279 B `app_data.js` (printed at build time) — not the ceiling — is the authoritative
figure.
...
- W1 found only one of the 35 documents in the 2026-09-10 register fully collated to its claimed witness; the 2026-09-20 overlay records the Congronglu reinstatement as the second (100/100 cases, 0 flagged), while Wumenguan and Xinxin Ming need per-document remediation, while the remaining partial/failed and unavailable states remain contained. Zhaozhou's claimed witness T1987 is the Caoshan record — W1 found the claim false, and re-pointing to X68n1315 is R-A work, deliberately not done here.
