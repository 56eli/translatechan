...
- [ ] **REMEDIATION hybrid policy**: per-doc work packages in `.orchestrator/REMEDIATION_PLAN.md`; delegate to coder agents, one document per PR. Wave 1 progress: wumenguan done (PR #29); **next: biyanlu_cases** (42 flagged), then linji_yulu, xinxin_ming, platform_sutra
