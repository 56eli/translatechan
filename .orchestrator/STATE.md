...
- [ ] **REMEDIATION hybrid policy**: per-doc work packages in `.orchestrator/REMEDIATION_PLAN.md`; delegate to coder agents, one document per PR. Wave 1 progress: wumenguan (PR #29), biyanlu_cases (PR #30), linji_yulu (PR #N); **next: xinxin_ming**, then platform_sutra
