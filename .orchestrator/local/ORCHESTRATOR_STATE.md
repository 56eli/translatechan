...
| 036 | .orchestrator/prompts/031-phase5-bundle-8-15-usable-handpick.md | Phase5 — Bundle 8-15 usable handpick, keep 1-7, add 8-15 more usable before review | feature/phase5-bundle-8-15-usable-handpick | — | Published 2026-09-14 — keep 1-7 (1 ideal, 2 kept, 3-7 truly drastic PR79), add 8-15 more usable with handpickable elements: 8 Tabbed+Breadcrumb, 9 Bottom Sheet, 10 Sticky TOC 16rem/1fr/16rem, 11 Search-First landing, 12 Question-Driven Where from/Who related/Background, 13 Side-by-Side English/Chinese collapsed, 14 Related Rail 18rem hover why related, 15 Footnotes+Glossary dotted hover, each 300-600 lines CSS overriding shell+nav+body but keeping nav+filter visible, visually distinct but usable, keep ideal colors, common qualities, bundle <30MB, text integrity required presentation allowed to break |
