...
| 033 | .orchestrator/prompts/029-phase5-truly-drastic-roadmap-8-12.md | Phase5 — Truly drastic roadmap 8-12 why 1-7 same shell + roadmap shell+nav+grid+IA | feature/phase5-truly-drastic-8-12-roadmap | — | Published 2026-09-14 — analysis why 1-7 same (same shell, same tokens, same HTML, post-process only ~292 lines), roadmap for truly drastic (must override shell+nav+body, change nav paradigm, grid, IA, alternative renderer, keep ideal colors, 30MB, presentation OFF) — superseded by 030 per owner 3-7 must be completely redone |
| 034 | .orchestrator/ANALYSIS_ALLOW_DRASTIC_2026-09-14_V2.md | ANALYSIS — What we're doing to allow drastic (bundle 30MB + presentation OFF + shell+nav+grid+IA must change) | fix/analysis-allow-drastic-v2 | — | Published 2026-09-14 — elaborates why 1-7 same, what we're doing: bundle 2MB->30MB, presentation gates OFF text integrity required, roadmap must change shell+nav+grid+IA+renderer, measurement criteria |
| 035 | .orchestrator/prompts/030-phase5-redo-3-7-truly-drastic.md | Phase5 — Redo 3-7 truly drastic, keep 1 and 2, completely redo 3-7 | feature/phase5-redo-3-7-truly-drastic | #79 | Merged 2026-09-14 — main 1b5d929 — keep 1 ideal no override + 2 Accordion Reader kept, completely redo 3-7 truly drastic: 3 Focus 38rem centered no sidebar whitespace 3x, 4 Timeline horizontal flex scroll-snap cards 18-26rem gold rail, 5 Graph+Reader split 32% sticky dots / 68% reader new DOM split, 6 Hamburger minimal header 3rem nav in drawer 42rem body, 7 Dossier info-first inverted translation collapsed, each 300-800 lines CSS overriding shell+nav+body visually distinct at first glance, keep ideal colors, common qualities 34/34 24/24 31/31 4/4, bundle <30MB, text integrity PASS, presentation OFF allowed to break (smoke legibility floor) |
| 036 | .orchestrator/prompts/031-phase5-bundle-8-15-usable-handpick.md | Phase5 — Bundle 8-15 usable handpick, keep 1-7, add 8-15 more usable before review | feature/phase5-bundle-8-15-usable-handpick | #80 | Merged 2026-09-14 — main 7cdf4b1 — keep 1-7 (1 ideal no override, 2 kept, 3-7 truly drastic PR79 Focus/Timeline/Graph+Split/Hamburger/Dossier), add 8-15 more usable handpickable: 8 Tabbed+Breadcrumb sticky tabs + breadcrumb drawer, 9 Bottom Sheet 46rem + bottom sheet handle, 10 Sticky TOC 16rem/1fr/16rem titles left reading centre context right, 11 Search-First 32rem search + explanation + 20rem cards, 12 Question-Driven Where from/Who related/Background drawers, 13 Side-by-Side English left Chinese right collapsed foldable, 14 Related Rail 18rem rail why on hover, 15 Footnotes+Glossary 44rem footnotes + dotted glossary tooltips, each 300-600 lines CSS 8=422 9=342 10=343 11=317 12=304 13=307 14=307 15=330 pure addition 2726 lines 0 deleted, nav visible filter reachable English first info sections 34/34 24/24 31/31 4/4 13/13, ideal colors, visually distinct but usable, bundle <30MB key assets 2.30MB raw, text integrity PASS, presentation OFF allowed to break, law PASS |
| 037 | .orchestrator/prompts/032-phase5-bundle-16-25-more-usable.md | Phase5 — Bundle 16-25 more usable handpick, keep 1-15, add 16-25 before review | feature/phase5-bundle-16-25-more-usable | #81 | Merged 2026-09-18 — main 8896b9e — keep 1-15 (1 ideal, 2 kept, 3-7 truly drastic PR79 Focus/Timeline/Graph+Split/Hamburger/Dossier, 8-15 usable PR80 Tabbed/BottomSheet/StickyTOC/SearchFirst/QuestionDriven/SideBySide/RelatedRail/FootnotesGlossary), add 16-25 more usable: 16 Progressive Scroll reveal on scroll + progress bar, 17 Modal Info ⓘ modal overlay, 18 Hover Cards dotted hover, 19 Sentence-by-Sentence [i] per sentence, 20 Chapter Chunks Continue per chunk, 21 Work Dossier header info, 22 Teacher Dossier origin teacher/disciples, 23 Two-Step Read more + Show context, 24 Command Palette cmd+k, 25 Trail+PrevNext+Slider+InlineOrigin bookmark trail + prev/next + slider + inline origin, each 300-600 lines CSS overriding shell+nav+body but keeping nav+filter visible, visually distinct but usable, switcher 1-25, ideal colors, common qualities 34/34 24/24 31/31, bundle <30MB, text integrity PASS |
| 038 | .orchestrator/prompts/033-phase5-bundle-26-35-final-batch.md | Phase5 — Bundle 26-35 final batch before review, keep 1-25, add 26-35 | feature/phase5-bundle-26-35-final-batch | #82 | Merged 2026-09-18 — main 268bf9c — keep 1-25 (1 ideal, 2 kept, 3-7 truly drastic PR79, 8-15 usable PR80, 16-25 more usable PR81), add 26-35 final batch: 26 Empty State Guidance plain language guide what is Chan where from who related background, 27 Comparison Slider range blend witnesses, 28 Inline Teacher Origin name+era hover expands where from teacher/disciples background, 29 Minimal Header Full-Bleed 2rem header top nav bar horizontal, 30 Magazine Spread 2-col drop cap English left context right, 31 Card Wall masonry 18rem cards expand dossier, 32 Vertical Timeline dots left content right chronological, 33 Split Resizable 60/40 drag handle, 34 Glossary Sidebar 14rem + Footnotes sidebar + tooltips, 35 Focus+TOC Hybrid 10rem/40rem/10rem mini TOC + progress rail + trail, each 300-600 lines CSS overriding shell+nav+body but keeping nav+filter visible, visually distinct but usable, switcher 1-35, ideal colors, common qualities 34/34 24/24 31/31, bundle <30MB ~6MB, text integrity PASS |
| 039 | .orchestrator/prompts/034-phase5-demo-36-chan-library-integration.md | Phase5 — Demo 36 Chan Buddhism Digital Library Integration, keep 1-35, add 36 from provided zip | feature/phase5-demo-36-chan-library-integration | #83 | Merged 2026-09-18 — main 9af86f2 — keep 1-35 (1 ideal no override, 2 kept, 3-7 truly drastic PR79, 8-15 usable PR80, 16-25 more usable PR81, 26-35 final batch PR82), add 36 Chan Library The Chan Room from owner-provided chan-buddhism-digital-library.zip 293KB, hand-ported as design variant 36, 916 lines CSS + 189 lines JS, switcher 1-36 live, ideal colors? library's own but adapted, common qualities 34/34 24/24 31/31, bundle <30MB, text integrity PASS, zip included |
...
- [x] 023 — Phase5 iteration — PR #79 Merged main 1b5d929 — keep 1 and 2, completely redo 3-7 truly drastic: Focus/Timeline/Graph+Split/Hamburger/Dossier, shell+nav+grid+IA, 300-800 lines each, visually distinct, keep ideal colors, common qualities, bundle <30MB, text integrity PASS, presentation OFF allowed to break
- [x] 024 — Phase5 iteration — PR #80 Merged main 7cdf4b1 — bundle 8-15 usable handpick, keep 1-7, add 8 Tabbed+Breadcrumb + 9 Bottom Sheet + 10 Sticky TOC + 11 Search-First + 12 Question-Driven + 13 Side-by-Side + 14 Related Rail + 15 Footnotes+Glossary, each 300-600 lines CSS handpickable, nav visible filter reachable, bundle <30MB, text integrity PASS
- [x] 025 — Phase5 iteration — PR #81 Merged main 8896b9e — bundle 16-25 more usable, keep 1-15, add 16 Progressive Scroll + 17 Modal Info + 18 Hover Cards + 19 Sentence-by-Sentence + 20 Chapter Chunks + 21 Work Dossier + 22 Teacher Dossier + 23 Two-Step + 24 Command Palette + 25 Trail+PrevNext+Slider+InlineOrigin, each 300-600 lines CSS, switcher 1-25 live, bundle <30MB, text integrity PASS
- [x] 026 — Phase5 iteration — PR #82 Merged main 268bf9c — bundle 26-35 final batch before review, keep 1-25, add 26 Empty State + 27 Slider + 28 Inline Origin + 29 Full-Bleed 2rem top nav + 30 Magazine 2-col drop cap + 31 Card Wall masonry + 32 Vertical Timeline + 33 Split Resizable 60/40 + 34 Glossary Sidebar + 35 Focus+TOC Hybrid, each 300-600 lines CSS, switcher 1-35 live, bundle <30MB ~6MB, text integrity PASS, final batch before review
- [x] 027 — Phase5 review — PR #83 Merged main 9af86f2 — demo 36 Chan Library The Chan Room from owner-provided zip 293KB, keep 1-35, add 36 hand-ported 916 lines CSS + 189 lines JS, switcher 1-36 live, bundle <30MB, text integrity PASS, final batch before targeted build
- [ ] 028 — Phase5 review — owner cycles live 1-36 via buttons, rates each 1-10 aim 8+, picks which elements handpickable for targeted page build, which of 26-36 feels most usable, which elements to handpick for final targeted build 37, each adds number, as many switches as technicalities allow, presentation OFF while experimenting, bundle 30MB — MUST include law verbatim + common qualities + ask does this look good? right direction? 1-10 aim 8+
