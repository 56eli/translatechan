...
| 037 | .orchestrator/prompts/032-phase5-bundle-16-25-more-usable.md | Phase5 — Bundle 16-25 more usable handpick, keep 1-15, add 16-25 before review | feature/phase5-bundle-16-25-more-usable | — | Published 2026-09-14 — keep 1-15 (1 ideal, 2 kept, 3-7 truly drastic PR79, 8-15 usable PR80), add 16-25 more usable handpickable: 16 Progressive Scroll, 17 Modal Info, 18 Hover Cards, 19 Sentence-by-Sentence, 20 Chapter Chunks, 21 Work Dossier, 22 Teacher Dossier, 23 Two-Step, 24 Command Palette cmd+k, 25 Trail+PrevNext+Slider+InlineOrigin, each 300-600 lines CSS overriding shell+nav+body but keeping nav+filter visible, visually distinct but usable, keep ideal colors, common qualities, bundle <30MB, text integrity required presentation allowed to break |
...
- [ ] 025 — Phase5 iteration — owner cycles live 1-15 via buttons, rates each 1-10 aim 8+, picks which elements handpickable for targeted page build, which of 8-15 feels most usable, which of 16-35 next, each adds number, as many switches as technicalities allow, presentation OFF while experimenting, bundle 30MB — MUST include law verbatim + common qualities + ask does this look good? right direction? 1-10 aim 8+
