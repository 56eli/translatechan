...
| 035 | .orchestrator/prompts/030-phase5-redo-3-7-truly-drastic.md | Phase5 — Redo 3-7 truly drastic, keep 1 and 2, completely redo 3-7 | feature/phase5-redo-3-7-truly-drastic | — | Published 2026-09-14 — keep 1 ideal no override + 2 Accordion Reader byte-identical kept, completely redo 3-7: 3 Focus 38rem centered no sidebar whitespace 3x, 4 Timeline horizontal scroll cards 18-26rem scroll-snap, 5 Graph+Reader split 32/68 dots sticky, 6 Hamburger minimal header 3rem nav behind drawer, 7 Info-First dossier inverted, each 300-800 lines CSS overriding shell+nav+body visually distinct, keep ideal colors, common qualities, bundle <30MB, text integrity required presentation allowed to break |
