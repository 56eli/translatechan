...
| 061 | .orchestrator/prompts/061-p0-regreen-main-17-docs.md | P0 re-green `main`: re-pin 3 gates to the 17-doc corpus | fix/p0-regreen-main-17-docs | — | Dispatched 2026-09-22 |
...
- Source preservation: corpus byte-compared against `BASE_COMMIT`
  ...
  via a `DECLARED_NEW_CORPUS` registration with dated evidence prose (owner ruling 2026-09-22).
...
- Branch protection on `main` unconfirmed; PR #113 merged with a red required check, so either
  protection is absent or it was bypassed. Worth an owner question before the next merge.
