...
10. **🚢 SHIPPED**: handoff/readme/roadmap refreshed (session delta map, campaign tally), **[PR #2](https://github.com/56eli/translatechan/pull/2) opened & MERGED** (`f035254`), GitHub Pages rebuilt and **the live site now serves the healed app** — smoke-tested, 79 verified slots live.
11. **Still open**: Phase 2 content (Wumenguan 11→48 — Yamada/Aitken proven fully fetchable), optional further verification rounds, lineage depth pass.
