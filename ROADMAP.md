...
- [x] **Data Contract & Release Guardrails**:
  ...
  - `data/lineage/lineage_verification.json` aggregates all 30 in-set graph links and 4 unprofiled frontiers with source-record status; the public chart never renders them as source-verified until exact locators are reviewed.
...
│   ├── lineage/                # masters.json + lineage_verification.json (30 links / 4 frontiers)
